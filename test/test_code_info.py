...
class TestCodeInfo(unittest.TestCase):
    ...
    def testCodeInfo(self):
        ...
        # model = douyin_open.EnterpriseGrouponGrouponOrderOrderDetail.models.code_info.CodeInfo()  # noqa: E501
        pass
